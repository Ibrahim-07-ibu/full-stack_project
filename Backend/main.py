    ...
    try:
        if db_seed.query(Service).count() == 0:
            ...
            seed_services = [
                ...
                Service(name="Deep Cleaning", price=800, description="Complete deep cleaning for home or office"),
                ...
                Service(name="AC Repair", price=600, description="Air conditioner repair and servicing"),
                Service(name="Carpentry", price=450, description="Furniture repair and carpentry work"),
                Service(name="Painting", price=700, description="Home and office painting services"),
